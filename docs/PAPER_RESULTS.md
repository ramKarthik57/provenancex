...
3. **Scope Disentanglement**: Pure in-memory correlation speed (12.4 µs) was disentangled from physical compilation overhead (0.24%, ~2.4 ms) and disk streaming hash throughput (48.2 ms for 100MB release binaries).
