...
// GenerateReproductionReport constructs the complete independent reproduction guide
...
`, env.OperatingSystem, env.HostArchitecture, env.LogicalCores, env.GoVersion,
		env.GitCommit, env.GitBranch, env.WorkingTreeClean, env.HistoricalBaselinesFrozenCount)
}
